...
<pre crayon="false" class="">export MUNGEUSER=991
...
<pre crayon="false" class="">yum install epel-release</pre>
...
<pre crayon="false" class="">yum install openssl openssl-devel pam-devel numactl numactl-devel hwloc hwloc-devel lua lua-devel readline-devel rrdtool-devel ncurses-devel man2html libibmad libibumad -y</pre>
...
<p>download the latest stable version of slurm by click: <a href="https://www.schedmd.com/downloads.php">slurm-17.02.6.TAR.BZ2</a></p>
<pre crayon="false" class="">cd /nfs
</pre>
<p>If you don&#8217;t have rpmbuild yet:</p>
<pre crayon="false" class="">yum install rpm-build
rpmbuild -ta slurm-17.02.6.tar.bz2</pre>
...
cp /root/rpmbuild/BUILD/slurm-17.02.6/src/plugins/auth/munge/.libs/auth_munge.so /usr/lib64/slurm/
cp /root/rpmbuild/BUILD/slurm-17.02.6/src/plugins/crypto/munge/.libs/crypto_munge.so /usr/lib64/slurm/</pre>
...
<pre crayon="false" class="">Compute node bugs: tail /var/log/slurmd.log
Server node bugs: tail /var/log/slurmctld.log</pre>
<p>&nbsp;</p>
